...
ActiveRecord::Schema.define(version: 2021_03_10_134049) do
  ...
  create_table "items", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["wholesaler_id"], name: "index_items_on_wholesaler_id"
  end
  ...
  create_table "wholesalers", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["uid", "provider"], name: "index_wholesalers_on_uid_and_provider", unique: true
  end

  add_foreign_key "active_storage_attachments", "active_storage_blobs", column: "blob_id"
  add_foreign_key "active_storage_variant_records", "active_storage_blobs", column: "blob_id"
  add_foreign_key "items", "wholesalers"
end
